...
public class Application extends BaseEntity {
    ...
    @Column(columnDefinition = "decimal(5,2) DEFAULT NULL COMMENT '금리'")
    private BigDecimal interestRate;

    @Column(columnDefinition = "decimal(5,2) DEFAULT 0 COMMENT '취급수수료'")
    ...
    @Column(columnDefinition = "datetime DEFAULT NULL COMMENT '집행 일자'")
